...
function serialize_tinkoff_public_invest_api_contract_v1_GetOrderPriceRequest(arg) {
  if (!(arg instanceof orders_pb.GetOrderPriceRequest)) {
    throw new Error('Expected argument of type tinkoff.public.invest.api.contract.v1.GetOrderPriceRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_tinkoff_public_invest_api_contract_v1_GetOrderPriceRequest(buffer_arg) {
  return orders_pb.GetOrderPriceRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_tinkoff_public_invest_api_contract_v1_GetOrderPriceResponse(arg) {
  if (!(arg instanceof orders_pb.GetOrderPriceResponse)) {
    throw new Error('Expected argument of type tinkoff.public.invest.api.contract.v1.GetOrderPriceResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_tinkoff_public_invest_api_contract_v1_GetOrderPriceResponse(buffer_arg) {
  return orders_pb.GetOrderPriceResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_tinkoff_public_invest_api_contract_v1_OrderStateStreamRequest(arg) {
  if (!(arg instanceof orders_pb.OrderStateStreamRequest)) {
    throw new Error('Expected argument of type tinkoff.public.invest.api.contract.v1.OrderStateStreamRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_tinkoff_public_invest_api_contract_v1_OrderStateStreamRequest(buffer_arg) {
  return orders_pb.OrderStateStreamRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_tinkoff_public_invest_api_contract_v1_OrderStateStreamResponse(arg) {
  if (!(arg instanceof orders_pb.OrderStateStreamResponse)) {
    throw new Error('Expected argument of type tinkoff.public.invest.api.contract.v1.OrderStateStreamResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_tinkoff_public_invest_api_contract_v1_OrderStateStreamResponse(buffer_arg) {
  return orders_pb.OrderStateStreamResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
orderStateStream: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: orders_pb.OrderStateStreamRequest,
    responseType: orders_pb.OrderStateStreamResponse,
    requestSerialize: serialize_tinkoff_public_invest_api_contract_v1_OrderStateStreamRequest,
    requestDeserialize: deserialize_tinkoff_public_invest_api_contract_v1_OrderStateStreamRequest,
    responseSerialize: serialize_tinkoff_public_invest_api_contract_v1_OrderStateStreamResponse,
    responseDeserialize: deserialize_tinkoff_public_invest_api_contract_v1_OrderStateStreamResponse,
  },
};
...
getOrderPrice: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: orders_pb.GetOrderPriceRequest,
    responseType: orders_pb.GetOrderPriceResponse,
    requestSerialize: serialize_tinkoff_public_invest_api_contract_v1_GetOrderPriceRequest,
    requestDeserialize: deserialize_tinkoff_public_invest_api_contract_v1_GetOrderPriceRequest,
    responseSerialize: serialize_tinkoff_public_invest_api_contract_v1_GetOrderPriceResponse,
    responseDeserialize: deserialize_tinkoff_public_invest_api_contract_v1_GetOrderPriceResponse,
  },
};
